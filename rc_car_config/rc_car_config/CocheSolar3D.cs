   ...
   class CocheSolar3D
{
        ...
        public void Run()
        {
            ...
            using (SharpDevice device = new SharpDevice(form))
            {
                ...
                SharpMesh mesh = SharpMesh.CreateFromObj(device, ".\\car\\car.obj");

                //init shader
                SharpShader shader = new SharpShader(device, ".\\car\\HLSL.txt",
                ...
                RenderLoop.Run(form, () =>
                {
                    ...
                    Matrix.RotationYawPitchRoll(yaw,pitch, roll, out world);
