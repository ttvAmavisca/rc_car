...
class VescUart
{
	...
	private: 
		...
		uint64_t timSend4= 0;
		uint64_t timSend5= 0;
		uint64_t sendinterValMax1= 15000; //15ms
		uint64_t sendinterValMax2= 15000; //15ms
		uint64_t sendinterValMax3= 15000; //15ms
		uint64_t sendinterValMax4= 15000; //15ms
		uint64_t sendinterValMax5= 15000; //15ms
