...
IMU_MPU9250::IMU_MPU9250( int8_t csPin, SPIClass &spiInterface, uint32_t spi_freq )
{
...
IMU_MPU9250::IMU_MPU9250( uint8_t address, TwoWire &wirePort, uint32_t clock_frequency )
{
	_I2Caddr = address;
	_wire = &wirePort;
	_spi = NULL;
...
//Inicia MPU por I2C
void IMU_MPU9250::Setup()
{
  // Read the WHO_AM_I register, this is a good test of communication
  byte c = readByte(_I2Caddr, WHO_AM_I_MPU9250);
...
bool IMU_MPU9250::getValues()
{

  bool actualizado=false;

  if (readByte(_I2Caddr, INT_STATUS) & 0x01)
  {
...
void IMU_MPU9250::setupMagForSPI()
{
...
void IMU_MPU9250::readAccelData(int16_t * destination)
{
...
void IMU_MPU9250::readGyroData(int16_t * destination)
{
...
void IMU_MPU9250::readMagData(int16_t * destination)
{
...
int16_t IMU_MPU9250::readTempData()
{
...
void IMU_MPU9250::initAK8963(float * destination)
{
...
void IMU_MPU9250::calibrateMPU9250(float * gyroBias, float * accelBias)
{
...
// deviation is a pass.
void IMU_MPU9250::MPU9250SelfTest(float * destination)
{
...
void IMU_MPU9250::magCalMPU9250(float * bias_dest, float * scale_dest)
{
...
uint8_t IMU_MPU9250::writeByte(uint8_t deviceAddress, uint8_t registerAddress,
                        uint8_t data)
{
  if (_csPin != NOT_SPI)
  {
...
uint8_t IMU_MPU9250::writeByteSPI(uint8_t registerAddress, uint8_t writeData)
{
  uint8_t returnVal;
  ...
  _spi->endTransaction();
// #ifdef SERIAL_DEBUG
//   Serial.print("IMU_MPU9250::writeByteSPI slave returned: 0x");
//   Serial.println(returnVal, HEX);
// #endif
  return returnVal;
}

uint8_t IMU_MPU9250::writeByteWire(uint8_t deviceAddress, uint8_t registerAddress,
                            uint8_t data)
{
...
uint8_t IMU_MPU9250::readByte(uint8_t deviceAddress, uint8_t registerAddress)
{
  if (_csPin != NOT_SPI)
  {
...
uint8_t IMU_MPU9250::readMagByteSPI(uint8_t registerAddress)
{
  setupMagForSPI();
...
uint8_t IMU_MPU9250::writeMagByteSPI(uint8_t registerAddress, uint8_t data)
{
  setupMagForSPI();
...
uint8_t IMU_MPU9250::readByteWire(uint8_t deviceAddress, uint8_t registerAddress)
{
...
uint8_t IMU_MPU9250::readByteSPI(uint8_t registerAddress)
{
...
uint8_t IMU_MPU9250::readBytesWire(uint8_t deviceAddress, uint8_t registerAddress,
...
void IMU_MPU9250::select()
{
  digitalWrite(_csPin, LOW);
}

// Select slave IC by deasserting CS pin
void IMU_MPU9250::deselect()
{
  digitalWrite(_csPin, HIGH);
}

uint8_t IMU_MPU9250::readBytesSPI(uint8_t registerAddress, uint8_t count,
                           uint8_t * dest)
{
...
uint8_t IMU_MPU9250::readBytes(uint8_t deviceAddress, uint8_t registerAddress,
                        uint8_t count, uint8_t * dest)
{
...
#ifdef SERIAL_DEBUG
  Serial.print("IMU_MPU9250::magInit to return ");
...
uint8_t IMU_MPU9250::ak8963WhoAmI_SPI()
{
